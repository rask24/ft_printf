...
/*   Updated: 2023/09/14 19:09:56 by reasuke          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static void	parse_spec(t_format_spec *fs, t_format_log *fl)
{
	ptrdiff_t	index;
...
static void	format_dispather(t_format_spec *fs, t_format_log *fl, va_list *ap)
{
	char	*str;
